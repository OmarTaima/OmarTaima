...
`React` • `TypeScript` • `Vite` • `TanStack React Query` • `Redux Toolkit` • `Material UI` • `Tailwind CSS` • `Axios`

**Repository**

https://github.com/Saber-Group-EG/Job-Application-Maker
...
`React 19` • `TypeScript` • `TanStack React Query` • `Material UI` • `Tailwind CSS` • `Formik` • `Yup` • `Axios`

**Repository**

https://github.com/Saber-Group-EG/marktingmangmentdashboard
